...
# Only run if not inside tmux already
...
# --- hook after zvm loads ---
# autoload -Uz add-zsh-hook

# function zvm_custom_clipboard_setup() {
...
# add-zsh-hook precmd zvm_custom_clipboard_setup

# Clear the terminal visually on new shell
if [[ $- == *i* ]]; then
    clear
fi
